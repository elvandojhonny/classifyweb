    ...
    <div class="col-lg-8">
        ...
        <div class="form-card">
            ...
            <div class="form-header">
                ...
                <p>
                    Perbarui data ruang kelas yang tersedia dalam sistem
                </p>
            ...
            <form method="POST"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="keterangan"
                              ...
                              placeholder="Contoh: Kapasitas 40 orang, tersedia AC, WIFI dan Proyektor">{{ old('keterangan', $kelas->keterangan) }}</textarea>
